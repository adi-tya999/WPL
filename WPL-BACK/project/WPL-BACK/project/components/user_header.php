   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home.php"  class="logo"><i class="fas fa-house"></i>MyHome</a>
            ...
            <li><a href="post_property.php" style =" color: var(--blue);
   background-color: var(--red);padding :1px;"><button class ="button-29"> post property<i class="fas-fa-paper-plane"></i>
</button></a></li>
</div> </ul>
